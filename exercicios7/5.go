...
func (p porSobrenome) Len() string           { return len(p) }
func (p porSobrenome) Less(i, j string) bool { return p[i].Last < p[j].Last }
func (p porSobrenome) Swap(i, j string)      { p[i], p[j] = p[j], p[i] }
